...
public class SampleValidationTest {
    ...
    public void ps256() {
        ...
        String privateKey = "-----BEGIN PRIVATE KEY-----\n" +
                ...
                "-----END PRIVATE KEY-----";
        JwtNode node = Jwt.parseOrNull(jwt);
        JwtPairPublicKey jwtPublicKey = JwtKey.parsePairPublicByPem(PS256, publicKey);
        JwtPairPrivateKey jwtPrivateKey = JwtKey.parsePairPrivateByPem(PS256, privateKey);
    ...
    public void ps384() {
        ...
        String privateKey = "-----BEGIN PRIVATE KEY-----\n" +
                ...
                "-----END PRIVATE KEY-----";
        JwtNode node = Jwt.parseOrNull(jwt);
        JwtPairPublicKey jwtPublicKey = JwtKey.parsePairPublicByPem(PS384, publicKey);
        JwtPairPrivateKey jwtPrivateKey = JwtKey.parsePairPrivateByPem(PS384, privateKey);
    ...
    public void ps512() {
        ...
        String privateKey = "-----BEGIN PRIVATE KEY-----\n" +
                ...
                "-----END PRIVATE KEY-----";
        JwtNode node = Jwt.parseOrNull(jwt);
        JwtPairPublicKey jwtPublicKey = JwtKey.parsePairPublicByPem(PS512, publicKey);
        JwtPairPrivateKey jwtPrivateKey = JwtKey.parsePairPrivateByPem(PS512, privateKey);
    ...
    public void rs256() {
        ...
        String privateKey = "-----BEGIN PRIVATE KEY-----\n" +
                ...
                "-----END PRIVATE KEY-----";
        JwtNode node = Jwt.parseOrNull(jwt);
        JwtPairPublicKey jwtPublicKey = JwtKey.parsePairPublicByPem(RS256, publicKey);
        JwtPairPrivateKey jwtPrivateKey = JwtKey.parsePairPrivateByPem(RS256, privateKey);
    ...
    public void rs384() {
        ...
        String privateKey = "-----BEGIN PRIVATE KEY-----\n" +
                ...
                "-----END PRIVATE KEY-----";
        JwtNode node = Jwt.parseOrNull(jwt);
        JwtPairPublicKey jwtPublicKey = JwtKey.parsePairPublicByPem(RS384, publicKey);
        JwtPairPrivateKey jwtPrivateKey = JwtKey.parsePairPrivateByPem(RS384, privateKey);
    ...
    public void rs512() {
        ...
        String privateKey = "-----BEGIN PRIVATE KEY-----\n" +
                ...
                "-----END PRIVATE KEY-----";
        JwtNode node = Jwt.parseOrNull(jwt);
        JwtPairPublicKey jwtPublicKey = JwtKey.parsePairPublicByPem(RS512, publicKey);
        JwtPairPrivateKey jwtPrivateKey = JwtKey.parsePairPrivateByPem(RS512, privateKey);
